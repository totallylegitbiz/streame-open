...
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    {
        return array(
            array('/usr/src/www/wooly/usr/src/www/wooly/files/foo.txt', '/files/=/usr/src/www/wooly/', '/files/usr/src/www/wooly/files/foo.txt'),
            array('/home/foo/bar.txt', '/files/=/usr/src/www/wooly/,/baz/=/home/foo/', '/baz/bar.txt'),
        );
    }
